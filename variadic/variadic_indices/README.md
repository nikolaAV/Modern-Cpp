...
* Indices for tuples. Usage example: [for_each](../../tuple/for-each), [zip_iterator](https://github.com/nikolaAV/skeleton/tree/master/algorithm/zip_iterator), [init_from_string_literal](../../tuple/init_from_string_literal)
