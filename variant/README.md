# C++ 17 [`std::variant`](https://en.cppreference.com/w/cpp/utility/variant) + [`std::visit`](https://en.cppreference.com/w/cpp/utility/variant/visit) templates. A few useful examples
